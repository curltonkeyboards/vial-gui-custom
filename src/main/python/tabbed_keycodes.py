...
class MacroTab(QScrollArea):
    ...
    def __init__(self, parent, label, macro_keycodes, user_keycodes, tapdance_keycodes, base_macro_keycodes):
        super().__init__(parent)
        self.label = label
        ...
        self.add_header_dropdown("User Profiles", self.user_keycodes)
...
class FilteredTabbedKeycodes(QTabWidget):
    ...
    def __init__(self, parent=None, keycode_filter=keycode_filter_any):
        ...
        self.tabs = [
            ...
            MacroTab(self, "Macro", KEYCODES_MIDI_VELOCITY, KEYCODES_USER, KEYCODES_TAP_DANCE, KEYCODES_MACRO_BASE),
