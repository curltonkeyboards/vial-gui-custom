class keycodes_v6:
    kc = {
        ...
        # Gaming Controller Keycodes (0xCC79-0xCC91) - Moved from 0xCC60-0xCC78 to avoid collision with USER09-USER31
        "GAMING_MODE": 0xCC79,  # Toggle gaming mode
        "XBOX_A": 0xCC7A,  # A button (Button 0)
        "XBOX_B": 0xCC7B,  # B button (Button 1)
        "XBOX_X": 0xCC7C,  # X button (Button 2)
        "XBOX_Y": 0xCC7D,  # Y button (Button 3)
        "XBOX_LB": 0xCC7E,  # Left bumper (Button 4)
        "XBOX_RB": 0xCC7F,  # Right bumper (Button 5)
        "XBOX_BACK": 0xCC80,  # Back/Select (Button 6)
        "XBOX_START": 0xCC81,  # Start (Button 7)
        "XBOX_L3": 0xCC82,  # Left stick click (Button 8)
        "XBOX_R3": 0xCC83,  # Right stick click (Button 9)
        "LS_UP": 0xCC84,  # Left stick up (Axis 1 negative)
        "LS_DOWN": 0xCC85,  # Left stick down (Axis 1 positive)
        "LS_LEFT": 0xCC86,  # Left stick left (Axis 0 negative)
        "LS_RIGHT": 0xCC87,  # Left stick right (Axis 0 positive)
        "RS_UP": 0xCC88,  # Right stick up (Axis 3 negative)
        "RS_DOWN": 0xCC89,  # Right stick down (Axis 3 positive)
        "RS_LEFT": 0xCC8A,  # Right stick left (Axis 2 negative)
        "RS_RIGHT": 0xCC8B,  # Right stick right (Axis 2 positive)
        "LT": 0xCC8C,  # Left trigger (Axis 4)
        "RT": 0xCC8D,  # Right trigger (Axis 5)
        "DPAD_UP": 0xCC8E,  # D-pad Up (Button 12)
        "DPAD_DOWN": 0xCC8F,  # D-pad Down (Button 13)
        "DPAD_LEFT": 0xCC90,  # D-pad Left (Button 14)
        "DPAD_RIGHT": 0xCC91,  # D-pad Right (Button 15)
