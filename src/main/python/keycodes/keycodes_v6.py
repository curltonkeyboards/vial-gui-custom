class keycodes_v6:
    kc = {
        ...
        "MI_INVERSION_1": (0x8000 + 128 * 7) + 128 * 128 + 5 + 25 + 129, 
        "QK_KB":(0x8000 + 128 * 7) + 128 * 128 + 5 + 25 + 129 + 8,  # custom keycodes safe range
...
for x in range(8):
    keycodes_v6.kc["MI_INVERSION_{}".format(x)] = keycodes_v6.kc["MI_INVERSION_1"] + x
...
for x in range(128):
    ...
    keycodes_v6.kc["MI_CHORD_{}".format(x)] = keycodes_v6.kc["MI_CHORD_1"] + x
