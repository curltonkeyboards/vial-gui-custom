...
KEYCODES_MIDI_TRANSPOSITION = [
    ...
    K("MI_TRNS_N6", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n-6", "Midi set transposition to -4 semitones"),
    K("MI_TRNS_N5", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n-5", "Midi set transposition to -5 semitones"),
    K("MI_TRNS_N4", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n-4", "Midi set transposition to -4 semitones"),
    K("MI_TRNS_N3", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n-3", "Midi set transposition to -3 semitones"),
    K("MI_TRNS_N2", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n-2", "Midi set transposition to -2 semitones"),
    K("MI_TRNS_N1", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n-1", "Midi set transposition to -1 semitones"),
    K("MI_TRNS_0", "ᵀʳᵃⁿˢᵖᵒˢᵉ\nᴰᵉᶠᵃᵘˡᵗ", "Midi set no transposition"),
    K("MI_TRNS_1", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n+1", "Midi set transposition to +1 semitones"),
    K("MI_TRNS_2", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n+2", "Midi set transposition to +2 semitones"),
    K("MI_TRNS_3", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n+3", "Midi set transposition to +3 semitones"),
    K("MI_TRNS_4", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n+4", "Midi set transposition to +4 semitones"),
    K("MI_TRNS_5", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n+5", "Midi set transposition to +5 semitones"),
    K("MI_TRNS_6", "ᵀʳᵃⁿˢᵖᵒˢᵉ\n+6", "Midi set transposition to +6 semitones"),
    K("MI_TRNSD", "ᵀʳᵃⁿˢᵖᵒˢᵉ\nDown", "Midi decrease transposition"),
    K("MI_TRNSU", "ᵀʳᵃⁿˢᵖᵒˢᵉ\nUp", "Midi increase transposition"),
]
