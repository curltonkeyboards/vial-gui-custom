...
KEYCODES_MIDI_TRANSPOSITION = [
    ...
    K("MI_TRNS_0", "Key\nC major", "Midi set no transposition"),
    K("MI_TRNS_1", "Key\nC#major", "Midi set transposition to +1 semitones"),
    K("MI_TRNS_2", "Key\nD major", "Midi set transposition to +2 semitones"),
    K("MI_TRNS_3", "Key\nD#major", "Midi set transposition to +3 semitones"),
    K("MI_TRNS_4", "Key\nE major", "Midi set transposition to +4 semitones"),
    K("MI_TRNS_5", "Key\nF major", "Midi set transposition to +5 semitones"),
