...
KEYCODES_CC_ENCODERVALUE = [
    K("MI_CCENCODER_0", "CC 0\nExpression\nWheel", "CC Expression wheel 0"),
    K("MI_CCENCODER_1", "CC 1\nExpression\nWheel", "CC Expression wheel 1"),
    K("MI_CCENCODER_2", "CC 2\nExpression\nWheel", "CC Expression wheel 2"),
    K("MI_CCENCODER_3", "CC 3\nExpression\nWheel", "CC Expression wheel 3"),
    K("MI_CCENCODER_4", "CC 4\nExpression\nWheel", "CC Expression wheel 4"),
    K("MI_CCENCODER_5", "CC 5\nExpression\nWheel", "CC Expression wheel 5"),
    K("MI_CCENCODER_6", "CC 6\nExpression\nWheel", "CC Expression wheel 6"),
    K("MI_CCENCODER_7", "CC 7\nExpression\nWheel", "CC Expression wheel 7"),
    K("MI_CCENCODER_8", "CC 8\nExpression\nWheel", "CC Expression wheel 8"),
    K("MI_CCENCODER_9", "CC 9\nExpression\nWheel", "CC Expression wheel 9"),
    K("MI_CCENCODER_10", "CC 10\nExpression\nWheel", "CC Expression wheel 10"),
    K("MI_CCENCODER_11", "CC 11\nExpression\nWheel", "CC Expression wheel 11"),
    K("MI_CCENCODER_12", "CC 12\nExpression\nWheel", "CC Expression wheel 12"),
    K("MI_CCENCODER_13", "CC 13\nExpression\nWheel", "CC Expression wheel 13"),
    K("MI_CCENCODER_14", "CC 14\nExpression\nWheel", "CC Expression wheel 14"),
    K("MI_CCENCODER_15", "CC 15\nExpression\nWheel", "CC Expression wheel 15"),
    K("MI_CCENCODER_16", "CC 16\nExpression\nWheel", "CC Expression wheel 16"),
    K("MI_CCENCODER_17", "CC 17\nExpression\nWheel", "CC Expression wheel 17"),
    K("MI_CCENCODER_18", "CC 18\nExpression\nWheel", "CC Expression wheel 18"),
    K("MI_CCENCODER_19", "CC 19\nExpression\nWheel", "CC Expression wheel 19"),
    K("MI_CCENCODER_20", "CC 20\nExpression\nWheel", "CC Expression wheel 20"),
    K("MI_CCENCODER_21", "CC 21\nExpression\nWheel", "CC Expression wheel 21"),
    K("MI_CCENCODER_22", "CC 22\nExpression\nWheel", "CC Expression wheel 22"),
    K("MI_CCENCODER_23", "CC 23\nExpression\nWheel", "CC Expression wheel 23"),
    K("MI_CCENCODER_24", "CC 24\nExpression\nWheel", "CC Expression wheel 24"),
    K("MI_CCENCODER_25", "CC 25\nExpression\nWheel", "CC Expression wheel 25"),
    K("MI_CCENCODER_26", "CC 26\nExpression\nWheel", "CC Expression wheel 26"),
    K("MI_CCENCODER_27", "CC 27\nExpression\nWheel", "CC Expression wheel 27"),
    K("MI_CCENCODER_28", "CC 28\nExpression\nWheel", "CC Expression wheel 28"),
    K("MI_CCENCODER_29", "CC 29\nExpression\nWheel", "CC Expression wheel 29"),
    K("MI_CCENCODER_30", "CC 30\nExpression\nWheel", "CC Expression wheel 30"),
    K("MI_CCENCODER_31", "CC 31\nExpression\nWheel", "CC Expression wheel 31"),
    K("MI_CCENCODER_32", "CC 32\nExpression\nWheel", "CC Expression wheel 32"),
    K("MI_CCENCODER_33", "CC 33\nExpression\nWheel", "CC Expression wheel 33"),
    K("MI_CCENCODER_34", "CC 34\nExpression\nWheel", "CC Expression wheel 34"),
    K("MI_CCENCODER_35", "CC 35\nExpression\nWheel", "CC Expression wheel 35"),
    K("MI_CCENCODER_36", "CC 36\nExpression\nWheel", "CC Expression wheel 36"),
    K("MI_CCENCODER_37", "CC 37\nExpression\nWheel", "CC Expression wheel 37"),
    K("MI_CCENCODER_38", "CC 38\nExpression\nWheel", "CC Expression wheel 38"),
    K("MI_CCENCODER_39", "CC 39\nExpression\nWheel", "CC Expression wheel 39"),
    K("MI_CCENCODER_40", "CC 40\nExpression\nWheel", "CC Expression wheel 40"),
    K("MI_CCENCODER_41", "CC 41\nExpression\nWheel", "CC Expression wheel 41"),
    K("MI_CCENCODER_42", "CC 42\nExpression\nWheel", "CC Expression wheel 42"),
    K("MI_CCENCODER_43", "CC 43\nExpression\nWheel", "CC Expression wheel 43"),
    K("MI_CCENCODER_44", "CC 44\nExpression\nWheel", "CC Expression wheel 44"),
    K("MI_CCENCODER_45", "CC 45\nExpression\nWheel", "CC Expression wheel 45"),
    K("MI_CCENCODER_46", "CC 46\nExpression\nWheel", "CC Expression wheel 46"),
    K("MI_CCENCODER_47", "CC 47\nExpression\nWheel", "CC Expression wheel 47"),
    K("MI_CCENCODER_48", "CC 48\nExpression\nWheel", "CC Expression wheel 48"),
    K("MI_CCENCODER_49", "CC 49\nExpression\nWheel", "CC Expression wheel 49"),
    K("MI_CCENCODER_50", "CC 50\nExpression\nWheel", "CC Expression wheel 50"),
    K("MI_CCENCODER_51", "CC 51\nExpression\nWheel", "CC Expression wheel 51"),
    K("MI_CCENCODER_52", "CC 52\nExpression\nWheel", "CC Expression wheel 52"),
    K("MI_CCENCODER_53", "CC 53\nExpression\nWheel", "CC Expression wheel 53"),
    K("MI_CCENCODER_54", "CC 54\nExpression\nWheel", "CC Expression wheel 54"),
    K("MI_CCENCODER_55", "CC 55\nExpression\nWheel", "CC Expression wheel 55"),
    K("MI_CCENCODER_56", "CC 56\nExpression\nWheel", "CC Expression wheel 56"),
    K("MI_CCENCODER_57", "CC 57\nExpression\nWheel", "CC Expression wheel 57"),
    K("MI_CCENCODER_58", "CC 58\nExpression\nWheel", "CC Expression wheel 58"),
    K("MI_CCENCODER_59", "CC 59\nExpression\nWheel", "CC Expression wheel 59"),
    K("MI_CCENCODER_60", "CC 60\nExpression\nWheel", "CC Expression wheel 60"),
    K("MI_CCENCODER_61", "CC 61\nExpression\nWheel", "CC Expression wheel 61"),
    K("MI_CCENCODER_62", "CC 62\nExpression\nWheel", "CC Expression wheel 62"),
    K("MI_CCENCODER_63", "CC 63\nExpression\nWheel", "CC Expression wheel 63"),
    K("MI_CCENCODER_64", "CC 64\nExpression\nWheel", "CC Expression wheel 64"),
    K("MI_CCENCODER_65", "CC 65\nExpression\nWheel", "CC Expression wheel 65"),
    K("MI_CCENCODER_66", "CC 66\nExpression\nWheel", "CC Expression wheel 66"),
    K("MI_CCENCODER_67", "CC 67\nExpression\nWheel", "CC Expression wheel 67"),
    K("MI_CCENCODER_68", "CC 68\nExpression\nWheel", "CC Expression wheel 68"),
    K("MI_CCENCODER_69", "CC 69\nExpression\nWheel", "CC Expression wheel 69"),
    K("MI_CCENCODER_70", "CC 70\nExpression\nWheel", "CC Expression wheel 70"),
    K("MI_CCENCODER_71", "CC 71\nExpression\nWheel", "CC Expression wheel 71"),
    K("MI_CCENCODER_72", "CC 72\nExpression\nWheel", "CC Expression wheel 72"),
    K("MI_CCENCODER_73", "CC 73\nExpression\nWheel", "CC Expression wheel 73"),
    K("MI_CCENCODER_74", "CC 74\nExpression\nWheel", "CC Expression wheel 74"),
    K("MI_CCENCODER_75", "CC 75\nExpression\nWheel", "CC Expression wheel 75"),
    K("MI_CCENCODER_76", "CC 76\nExpression\nWheel", "CC Expression wheel 76"),
    K("MI_CCENCODER_77", "CC 77\nExpression\nWheel", "CC Expression wheel 77"),
    K("MI_CCENCODER_78", "CC 78\nExpression\nWheel", "CC Expression wheel 78"),
    K("MI_CCENCODER_79", "CC 79\nExpression\nWheel", "CC Expression wheel 79"),
    K("MI_CCENCODER_80", "CC 80\nExpression\nWheel", "CC Expression wheel 80"),
    K("MI_CCENCODER_81", "CC 81\nExpression\nWheel", "CC Expression wheel 81"),
    K("MI_CCENCODER_82", "CC 82\nExpression\nWheel", "CC Expression wheel 82"),
    K("MI_CCENCODER_83", "CC 83\nExpression\nWheel", "CC Expression wheel 83"),
    K("MI_CCENCODER_84", "CC 84\nExpression\nWheel", "CC Expression wheel 84"),
    K("MI_CCENCODER_85", "CC 85\nExpression\nWheel", "CC Expression wheel 85"),
    K("MI_CCENCODER_86", "CC 86\nExpression\nWheel", "CC Expression wheel 86"),
    K("MI_CCENCODER_87", "CC 87\nExpression\nWheel", "CC Expression wheel 87"),
    K("MI_CCENCODER_88", "CC 88\nExpression\nWheel", "CC Expression wheel 88"),
    K("MI_CCENCODER_89", "CC 89\nExpression\nWheel", "CC Expression wheel 89"),
    K("MI_CCENCODER_90", "CC 90\nExpression\nWheel", "CC Expression wheel 90"),
    K("MI_CCENCODER_91", "CC 91\nExpression\nWheel", "CC Expression wheel 91"),
    K("MI_CCENCODER_92", "CC 92\nExpression\nWheel", "CC Expression wheel 92"),
    K("MI_CCENCODER_93", "CC 93\nExpression\nWheel", "CC Expression wheel 93"),
    K("MI_CCENCODER_94", "CC 94\nExpression\nWheel", "CC Expression wheel 94"),
    K("MI_CCENCODER_95", "CC 95\nExpression\nWheel", "CC Expression wheel 95"),
    K("MI_CCENCODER_96", "CC 96\nExpression\nWheel", "CC Expression wheel 96"),
    K("MI_CCENCODER_97", "CC 97\nExpression\nWheel", "CC Expression wheel 97"),
    K("MI_CCENCODER_98", "CC 98\nExpression\nWheel", "CC Expression wheel 98"),
    K("MI_CCENCODER_99", "CC 99\nExpression\nWheel", "CC Expression wheel 99"),
    K("MI_CCENCODER_100", "CC 100\nExpression\nWheel", "CC Expression wheel 100"),
    K("MI_CCENCODER_101", "CC 101\nExpression\nWheel", "CC Expression wheel 101"),
    K("MI_CCENCODER_102", "CC 102\nExpression\nWheel", "CC Expression wheel 102"),
    K("MI_CCENCODER_103", "CC 103\nExpression\nWheel", "CC Expression wheel 103"),
    K("MI_CCENCODER_104", "CC 104\nExpression\nWheel", "CC Expression wheel 104"),
    K("MI_CCENCODER_105", "CC 105\nExpression\nWheel", "CC Expression wheel 105"),
    K("MI_CCENCODER_106", "CC 106\nExpression\nWheel", "CC Expression wheel 106"),
    K("MI_CCENCODER_107", "CC 107\nExpression\nWheel", "CC Expression wheel 107"),
    K("MI_CCENCODER_108", "CC 108\nExpression\nWheel", "CC Expression wheel 108"),
    K("MI_CCENCODER_109", "CC 109\nExpression\nWheel", "CC Expression wheel 109"),
    K("MI_CCENCODER_110", "CC 110\nExpression\nWheel", "CC Expression wheel 110"),
    K("MI_CCENCODER_111", "CC 111\nExpression\nWheel", "CC Expression wheel 111"),
    K("MI_CCENCODER_112", "CC 112\nExpression\nWheel", "CC Expression wheel 112"),
    K("MI_CCENCODER_113", "CC 113\nExpression\nWheel", "CC Expression wheel 113"),
    K("MI_CCENCODER_114", "CC 114\nExpression\nWheel", "CC Expression wheel 114"),
    K("MI_CCENCODER_115", "CC 115\nExpression\nWheel", "CC Expression wheel 115"),
    K("MI_CCENCODER_116", "CC 116\nExpression\nWheel", "CC Expression wheel 116"),
    K("MI_CCENCODER_117", "CC 117\nExpression\nWheel", "CC Expression wheel 117"),
    K("MI_CCENCODER_118", "CC 118\nExpression\nWheel", "CC Expression wheel 118"),
    K("MI_CCENCODER_119", "CC 119\nExpression\nWheel", "CC Expression wheel 119"),
    K("MI_CCENCODER_120", "CC 120\nExpression\nWheel", "CC Expression wheel 120"),
    K("MI_CCENCODER_121", "CC 121\nExpression\nWheel", "CC Expression wheel 121"),
    K("MI_CCENCODER_122", "CC 122\nExpression\nWheel", "CC Expression wheel 122"),
    K("MI_CCENCODER_123", "CC 123\nExpression\nWheel", "CC Expression wheel 123"),
    K("MI_CCENCODER_124", "CC 124\nExpression\nWheel", "CC Expression wheel 124"),
    K("MI_CCENCODER_125", "CC 125\nExpression\nWheel", "CC Expression wheel 125"),
    K("MI_CCENCODER_126", "CC 126\nExpression\nWheel", "CC Expression wheel 126"),
    K("MI_CCENCODER_127", "CC 127\nExpression\nWheel", "CC Expression wheel 127"),
]
...
def recreate_keycodes():
    ...
    KEYCODES.extend(KEYCODES_SPECIAL + KEYCODES_BASIC + KEYCODES_SHIFTED + KEYCODES_ISO + KEYCODES_LAYERS + KEYCODES_LAYERS_DF + KEYCODES_LAYERS_MO + KEYCODES_LAYERS_TG + KEYCODES_LAYERS_TT + KEYCODES_LAYERS_OSL + KEYCODES_LAYERS_TO + KEYCODES_LAYERS_LT +
                    ...
                    KEYCODES_TAP_DANCE + KEYCODES_MACRO + KEYCODES_MACRO_BASE + KEYCODES_EARTRAINER + KEYCODES_CHORDTRAINER + KEYCODES_USER + KEYCODES_HIDDEN + KEYCODES_MIDI+ KEYCODES_MIDI_CHANNEL_OS + KEYCODES_MIDI_CHANNEL_HOLD + KEYCODES_RGB_KC_CUSTOM + KEYCODES_RGB_KC_CUSTOM2 + KEYCODES_RGBSAVE + KEYCODES_MIDI_CHANNEL_KEYSPLIT + KEYCODES_MIDI_CHANNEL_KEYSPLIT2 + KEYCODES_KEYSPLIT_BUTTONS +
                    KEYCODES_MIDI_CC_FIXED+KEYCODES_MIDI_CC+KEYCODES_MIDI_CC_DOWN+KEYCODES_MIDI_CC_UP+KEYCODES_MIDI_BANK+KEYCODES_Program_Change+KEYCODES_MIDI_SMARTCHORDBUTTONS+KEYCODES_VELOCITY_STEPSIZE+KEYCODES_VELOCITY_SHUFFLE + KEYCODES_CC_ENCODERVALUE+
