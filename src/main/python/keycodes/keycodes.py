...
KEYCODES_MACRO = [
    ...
    K("M257", "Macro 257", "Macro 257"),
    K("M258", "Macro 258", "Macro 258"),
    K("M259", "Macro 259", "Macro 259"),
    K("M260", "Macro 260", "Macro 260"),
    K("M261", "Macro 261", "Macro 261"),
    K("M262", "Macro 262", "Macro 262"),
    K("M263", "Macro 263", "Macro 263"),
    K("M264", "Macro 264", "Macro 264"),
    K("M265", "Macro 265", "Macro 265"),
    K("M266", "Macro 266", "Macro 266"),
    K("M267", "Macro 267", "Macro 267"),
    K("M268", "Macro 268", "Macro 268"),
    K("M269", "Macro 269", "Macro 269"),
    K("M270", "Macro 270", "Macro 270"),
    K("M271", "Macro 271", "Macro 271"),
    K("M272", "Macro 272", "Macro 272"),
    K("M273", "Macro 273", "Macro 273"),
    K("M274", "Macro 274", "Macro 274"),
    K("M275", "Macro 275", "Macro 275"),
    K("M276", "Macro 276", "Macro 276"),
    K("M277", "Macro 277", "Macro 277"),
    K("M278", "Macro 278", "Macro 278"),
    K("M279", "Macro 279", "Macro 279"),
    K("M280", "Macro 280", "Macro 280"),
    K("M281", "Macro 281", "Macro 281"),
    K("M282", "Macro 282", "Macro 282"),
    K("M283", "Macro 283", "Macro 283"),
    K("M284", "Macro 284", "Macro 284"),
    K("M285", "Macro 285", "Macro 285"),
    K("M286", "Macro 286", "Macro 286"),
    K("M287", "Macro 287", "Macro 287"),
    K("M288", "Macro 288", "Macro 288"),
    K("M289", "Macro 289", "Macro 289"),
    K("M290", "Macro 290", "Macro 290"),
    K("M291", "Macro 291", "Macro 291"),
    K("M292", "Macro 292", "Macro 292"),
    K("M293", "Macro 293", "Macro 293"),
    K("M294", "Macro 294", "Macro 294"),
    K("M295", "Macro 295", "Macro 295"),
    K("M296", "Macro 296", "Macro 296"),
    K("M297", "Macro 297", "Macro 297"),
    K("M298", "Macro 298", "Macro 298"),
    K("M299", "Macro 299", "Macro 299"),
    K("M300", "Macro 300", "Macro 300")
]
...
KEYCODES_MIDI_SPLIT = [
        K("MI_SPLIT_C", "KeySplit\nC", "Midi send note C"),
        K("MI_SPLIT_Cs", "KeySplit\nC#/Dᵇ", "Midi send note C#/Dᵇ", alias=["MI_SPLIT_Db"]),
        K("MI_SPLIT_D", "KeySplit\nD", "Midi send note D"),
        K("MI_SPLIT_Ds", "KeySplit\nD#/Eᵇ", "Midi send note D#/Eᵇ", alias=["MI_SPLIT_Eb"]),
        K("MI_SPLIT_E", "KeySplit\nE", "Midi send note E"),
        K("MI_SPLIT_F", "KeySplit\nF", "Midi send note F"),
        K("MI_SPLIT_Fs", "KeySplit\nF#/Gᵇ", "Midi send note F#/Gᵇ", alias=["MI_SPLIT_Gb"]),
        K("MI_SPLIT_G", "KeySplit\nG", "Midi send note G"),
        K("MI_SPLIT_Gs", "KeySplit\nG#/Aᵇ", "Midi send note G#/Aᵇ", alias=["MI_SPLIT_Ab"]),
        K("MI_SPLIT_A", "KeySplit\nA", "Midi send note A"),
        K("MI_SPLIT_As", "KeySplit\nA#/Bᵇ", "Midi send note A#/Bᵇ", alias=["MI_SPLIT_Bb"]),
        K("MI_SPLIT_B", "KeySplit\nB", "Midi send note B"),

        K("MI_SPLIT_C_1", "KeySplit\nC₁", "Midi send note C₁"),
        K("MI_SPLIT_Cs_1", "KeySplit\nC#₁/Dᵇ₁", "Midi send note C#₁/Dᵇ₁", alias=["MI_SPLIT_Db_1"]),
        K("MI_SPLIT_D_1", "KeySplit\nD₁", "Midi send note D₁"),
        K("MI_SPLIT_Ds_1", "KeySplit\nD#₁/Eᵇ₁", "Midi send note D#₁/Eᵇ₁", alias=["MI_SPLIT_Eb_1"]),
        K("MI_SPLIT_E_1", "KeySplit\nE₁", "Midi send note E₁"),
        K("MI_SPLIT_F_1", "KeySplit\nF₁", "Midi send note F₁"),
        K("MI_SPLIT_Fs_1", "KeySplit\nF#₁/Gᵇ₁", "Midi send note F#₁/Gᵇ₁", alias=["MI_SPLIT_Gb_1"]),
        K("MI_SPLIT_G_1", "KeySplit\nG₁", "Midi send note G₁"),
        K("MI_SPLIT_Gs_1", "KeySplit\nG#₁/Aᵇ₁", "Midi send note G#₁/Aᵇ₁", alias=["MI_SPLIT_Ab_1"]),
        K("MI_SPLIT_A_1", "KeySplit\nA₁", "Midi send note A₁"),
        K("MI_SPLIT_As_1", "KeySplit\nA#₁/Bᵇ₁", "Midi send note A#₁/Bᵇ₁", alias=["MI_SPLIT_Bb_1"]),
        K("MI_SPLIT_B_1", "KeySplit\nB₁", "Midi send note B₁"),

        K("MI_SPLIT_C_2", "KeySplit\nC₂", "Midi send note C₂"),
        K("MI_SPLIT_Cs_2", "KeySplit\nC#₂/Dᵇ₂", "Midi send note C#₂/Dᵇ₂", alias=["MI_SPLIT_Db_2"]),
        K("MI_SPLIT_D_2", "KeySplit\nD₂", "Midi send note D₂"),
        K("MI_SPLIT_Ds_2", "KeySplit\nD#₂/Eᵇ₂", "Midi send note D#₂/Eᵇ₂", alias=["MI_SPLIT_Eb_2"]),
        K("MI_SPLIT_E_2", "KeySplit\nE₂", "Midi send note E₂"),
        K("MI_SPLIT_F_2", "KeySplit\nF₂", "Midi send note F₂"),
        K("MI_SPLIT_Fs_2", "KeySplit\nF#₂/Gᵇ₂", "Midi send note F#₂/Gᵇ₂", alias=["MI_SPLIT_Gb_2"]),
        K("MI_SPLIT_G_2", "KeySplit\nG₂", "Midi send note G₂"),
        K("MI_SPLIT_Gs_2", "KeySplit\nG#₂/Aᵇ₂", "Midi send note G#₂/Aᵇ₂", alias=["MI_SPLIT_Ab_2"]),
        K("MI_SPLIT_A_2", "KeySplit\nA₂", "Midi send note A₂"),
        K("MI_SPLIT_As_2", "KeySplit\nA#₂/Bᵇ₂", "Midi send note A#₂/Bᵇ₂", alias=["MI_SPLIT_Bb_2"]),
        K("MI_SPLIT_B_2", "KeySplit\nB₂", "Midi send note B₂"),

        K("MI_SPLIT_C_3", "KeySplit\nC₃", "Midi send note C₃"),
        K("MI_SPLIT_Cs_3", "KeySplit\nC#₃/Dᵇ₃", "Midi send note C#₃/Dᵇ₃", alias=["MI_SPLIT_Db_3"]),
        K("MI_SPLIT_D_3", "KeySplit\nD₃", "Midi send note D₃"),
        K("MI_SPLIT_Ds_3", "KeySplit\nD#₃/Eᵇ₃", "Midi send note D#₃/Eᵇ₃", alias=["MI_SPLIT_Eb_3"]),
        K("MI_SPLIT_E_3", "KeySplit\nE₃", "Midi send note E₃"),
        K("MI_SPLIT_F_3", "KeySplit\nF₃", "Midi send note F₃"),
        K("MI_SPLIT_Fs_3", "KeySplit\nF#₃/Gᵇ₃", "Midi send note F#₃/Gᵇ₃", alias=["MI_SPLIT_Gb_3"]),
        K("MI_SPLIT_G_3", "KeySplit\nG₃", "Midi send note G₃"),
        K("MI_SPLIT_Gs_3", "KeySplit\nG#₃/Aᵇ₃", "Midi send note G#₃/Aᵇ₃", alias=["MI_SPLIT_Ab_3"]),
        K("MI_SPLIT_A_3", "KeySplit\nA₃", "Midi send note A₃"),
        K("MI_SPLIT_As_3", "KeySplit\nA#₃/Bᵇ₃", "Midi send note A#₃/Bᵇ₃", alias=["MI_SPLIT_Bb_3"]),
        K("MI_SPLIT_B_3", "KeySplit\nB₃", "Midi send note B₃"),

        K("MI_SPLIT_C_4", "KeySplit\nC₄", "Midi send note C₄"),
        K("MI_SPLIT_Cs_4", "KeySplit\nC#₄/Dᵇ₄", "Midi send note C#₄/Dᵇ₄", alias=["MI_SPLIT_Db_4"]),
        K("MI_SPLIT_D_4", "KeySplit\nD₄", "Midi send note D₄"),
        K("MI_SPLIT_Ds_4", "KeySplit\nD#₄/Eᵇ₄", "Midi send note D#₄/Eᵇ₄", alias=["MI_SPLIT_Eb_4"]),
        K("MI_SPLIT_E_4", "KeySplit\nE₄", "Midi send note E₄"),
        K("MI_SPLIT_F_4", "KeySplit\nF₄", "Midi send note F₄"),
        K("MI_SPLIT_Fs_4", "KeySplit\nF#₄/Gᵇ₄", "Midi send note F#₄/Gᵇ₄", alias=["MI_SPLIT_Gb_4"]),
        K("MI_SPLIT_G_4", "KeySplit\nG₄", "Midi send note G₄"),
        K("MI_SPLIT_Gs_4", "KeySplit\nG#₄/Aᵇ₄", "Midi send note G#₄/Aᵇ₄", alias=["MI_SPLIT_Ab_4"]),
        K("MI_SPLIT_A_4", "KeySplit\nA₄", "Midi send note A₄"),
        K("MI_SPLIT_As_4", "KeySplit\nA#₄/Bᵇ₄", "Midi send note A#₄/Bᵇ₄", alias=["MI_SPLIT_Bb_4"]),
        K("MI_SPLIT_B_4", "KeySplit\nB₄", "Midi send note B₄"),

        K("MI_SPLIT_C_5", "KeySplit\nC₅", "Midi send note C₅"),
        K("MI_SPLIT_Cs_5", "KeySplit\nC#₅/Dᵇ₅", "Midi send note C#₅/Dᵇ₅", alias=["MI_SPLIT_Db_5"]),
        K("MI_SPLIT_D_5", "KeySplit\nD₅", "Midi send note D₅"),
        K("MI_SPLIT_Ds_5", "KeySplit\nD#₅/Eᵇ₅", "Midi send note D#₅/Eᵇ₅", alias=["MI_SPLIT_Eb_5"]),
        K("MI_SPLIT_E_5", "KeySplit\nE₅", "Midi send note E₅"),
        K("MI_SPLIT_F_5", "KeySplit\nF₅", "Midi send note F₅"),
        K("MI_SPLIT_Fs_5", "KeySplit\nF#₅/Gᵇ₅", "Midi send note F#₅/Gᵇ₅", alias=["MI_SPLIT_Gb_5"]),
        K("MI_SPLIT_G_5", "KeySplit\nG₅", "Midi send note G₅"),
        K("MI_SPLIT_Gs_5", "KeySplit\nG#₅/Aᵇ₅", "Midi send note G#₅/Aᵇ₅", alias=["MI_SPLIT_Ab_5"]),
        K("MI_SPLIT_A_5", "KeySplit\nA₅", "Midi send note A₅"),
        K("MI_SPLIT_As_5", "KeySplit\nA#₅/Bᵇ₅", "Midi send note A#₅/Bᵇ₅", alias=["MI_SPLIT_Bb_5"]),
        K("MI_SPLIT_B_5", "KeySplit\nB₅", "Midi send note B₅"),
...
KEYCODES_MIDI_SPLIT2 = [
        K("MI_SPLIT2_C", "Triple\nSplit\nC", "Midi send note C"),
        K("MI_SPLIT2_Cs", "Triple\nSplit\nC#/Dᵇ", "Midi send note C#/Dᵇ", alias=["MI_SPLIT2_Db"]),
        K("MI_SPLIT2_D", "Triple\nSplit\nD", "Midi send note D"),
        K("MI_SPLIT2_Ds", "Triple\nSplit\nD#/Eᵇ", "Midi send note D#/Eᵇ", alias=["MI_SPLIT2_Eb"]),
        K("MI_SPLIT2_E", "Triple\nSplit\nE", "Midi send note E"),
        K("MI_SPLIT2_F", "Triple\nSplit\nF", "Midi send note F"),
        K("MI_SPLIT2_Fs", "Triple\nSplit\nF#/Gᵇ", "Midi send note F#/Gᵇ", alias=["MI_SPLIT2_Gb"]),
        K("MI_SPLIT2_G", "Triple\nSplit\nG", "Midi send note G"),
        K("MI_SPLIT2_Gs", "Triple\nSplit\nG#/Aᵇ", "Midi send note G#/Aᵇ", alias=["MI_SPLIT2_Ab"]),
        K("MI_SPLIT2_A", "Triple\nSplit\nA", "Midi send note A"),
        K("MI_SPLIT2_As", "Triple\nSplit\nA#/Bᵇ", "Midi send note A#/Bᵇ", alias=["MI_SPLIT2_Bb"]),
        K("MI_SPLIT2_B", "Triple\nSplit\nB", "Midi send note B"),

        K("MI_SPLIT2_C_1", "Triple\nSplit\nC₁", "Midi send note C₁"),
        K("MI_SPLIT2_Cs_1", "Triple\nSplit\nC#₁/Dᵇ₁", "Midi send note C#₁/Dᵇ₁", alias=["MI_SPLIT2_Db_1"]),
        K("MI_SPLIT2_D_1", "Triple\nSplit\nD₁", "Midi send note D₁"),
        K("MI_SPLIT2_Ds_1", "Triple\nSplit\nD#₁/Eᵇ₁", "Midi send note D#₁/Eᵇ₁", alias=["MI_SPLIT2_Eb_1"]),
        K("MI_SPLIT2_E_1", "Triple\nSplit\nE₁", "Midi send note E₁"),
        K("MI_SPLIT2_F_1", "Triple\nSplit\nF₁", "Midi send note F₁"),
        K("MI_SPLIT2_Fs_1", "Triple\nSplit\nF#₁/Gᵇ₁", "Midi send note F#₁/Gᵇ₁", alias=["MI_SPLIT2_Gb_1"]),
        K("MI_SPLIT2_G_1", "Triple\nSplit\nG₁", "Midi send note G₁"),
        K("MI_SPLIT2_Gs_1", "Triple\nSplit\nG#₁/Aᵇ₁", "Midi send note G#₁/Aᵇ₁", alias=["MI_SPLIT2_Ab_1"]),
        K("MI_SPLIT2_A_1", "Triple\nSplit\nA₁", "Midi send note A₁"),
        K("MI_SPLIT2_As_1", "Triple\nSplit\nA#₁/Bᵇ₁", "Midi send note A#₁/Bᵇ₁", alias=["MI_SPLIT2_Bb_1"]),
        K("MI_SPLIT2_B_1", "Triple\nSplit\nB₁", "Midi send note B₁"),

        K("MI_SPLIT2_C_2", "Triple\nSplit\nC₂", "Midi send note C₂"),
        K("MI_SPLIT2_Cs_2", "Triple\nSplit\nC#₂/Dᵇ₂", "Midi send note C#₂/Dᵇ₂", alias=["MI_SPLIT2_Db_2"]),
        K("MI_SPLIT2_D_2", "Triple\nSplit\nD₂", "Midi send note D₂"),
        K("MI_SPLIT2_Ds_2", "Triple\nSplit\nD#₂/Eᵇ₂", "Midi send note D#₂/Eᵇ₂", alias=["MI_SPLIT2_Eb_2"]),
        K("MI_SPLIT2_E_2", "Triple\nSplit\nE₂", "Midi send note E₂"),
        K("MI_SPLIT2_F_2", "Triple\nSplit\nF₂", "Midi send note F₂"),
        K("MI_SPLIT2_Fs_2", "Triple\nSplit\nF#₂/Gᵇ₂", "Midi send note F#₂/Gᵇ₂", alias=["MI_SPLIT2_Gb_2"]),
        K("MI_SPLIT2_G_2", "Triple\nSplit\nG₂", "Midi send note G₂"),
        K("MI_SPLIT2_Gs_2", "Triple\nSplit\nG#₂/Aᵇ₂", "Midi send note G#₂/Aᵇ₂", alias=["MI_SPLIT2_Ab_2"]),
        K("MI_SPLIT2_A_2", "Triple\nSplit\nA₂", "Midi send note A₂"),
        K("MI_SPLIT2_As_2", "Triple\nSplit\nA#₂/Bᵇ₂", "Midi send note A#₂/Bᵇ₂", alias=["MI_SPLIT2_Bb_2"]),
        K("MI_SPLIT2_B_2", "Triple\nSplit\nB₂", "Midi send note B₂"),

        K("MI_SPLIT2_C_3", "Triple\nSplit\nC₃", "Midi send note C₃"),
        K("MI_SPLIT2_Cs_3", "Triple\nSplit\nC#₃/Dᵇ₃", "Midi send note C#₃/Dᵇ₃", alias=["MI_SPLIT2_Db_3"]),
        K("MI_SPLIT2_D_3", "Triple\nSplit\nD₃", "Midi send note D₃"),
        K("MI_SPLIT2_Ds_3", "Triple\nSplit\nD#₃/Eᵇ₃", "Midi send note D#₃/Eᵇ₃", alias=["MI_SPLIT2_Eb_3"]),
        K("MI_SPLIT2_E_3", "Triple\nSplit\nE₃", "Midi send note E₃"),
        K("MI_SPLIT2_F_3", "Triple\nSplit\nF₃", "Midi send note F₃"),
        K("MI_SPLIT2_Fs_3", "Triple\nSplit\nF#₃/Gᵇ₃", "Midi send note F#₃/Gᵇ₃", alias=["MI_SPLIT2_Gb_3"]),
        K("MI_SPLIT2_G_3", "Triple\nSplit\nG₃", "Midi send note G₃"),
        K("MI_SPLIT2_Gs_3", "Triple\nSplit\nG#₃/Aᵇ₃", "Midi send note G#₃/Aᵇ₃", alias=["MI_SPLIT2_Ab_3"]),
        K("MI_SPLIT2_A_3", "Triple\nSplit\nA₃", "Midi send note A₃"),
        K("MI_SPLIT2_As_3", "Triple\nSplit\nA#₃/Bᵇ₃", "Midi send note A#₃/Bᵇ₃", alias=["MI_SPLIT2_Bb_3"]),
        K("MI_SPLIT2_B_3", "Triple\nSplit\nB₃", "Midi send note B₃"),

        K("MI_SPLIT2_C_4", "Triple\nSplit\nC₄", "Midi send note C₄"),
        K("MI_SPLIT2_Cs_4", "Triple\nSplit\nC#₄/Dᵇ₄", "Midi send note C#₄/Dᵇ₄", alias=["MI_SPLIT2_Db_4"]),
        K("MI_SPLIT2_D_4", "Triple\nSplit\nD₄", "Midi send note D₄"),
        K("MI_SPLIT2_Ds_4", "Triple\nSplit\nD#₄/Eᵇ₄", "Midi send note D#₄/Eᵇ₄", alias=["MI_SPLIT2_Eb_4"]),
        K("MI_SPLIT2_E_4", "Triple\nSplit\nE₄", "Midi send note E₄"),
        K("MI_SPLIT2_F_4", "Triple\nSplit\nF₄", "Midi send note F₄"),
        K("MI_SPLIT2_Fs_4", "Triple\nSplit\nF#₄/Gᵇ₄", "Midi send note F#₄/Gᵇ₄", alias=["MI_SPLIT2_Gb_4"]),
        K("MI_SPLIT2_G_4", "Triple\nSplit\nG₄", "Midi send note G₄"),
        K("MI_SPLIT2_Gs_4", "Triple\nSplit\nG#₄/Aᵇ₄", "Midi send note G#₄/Aᵇ₄", alias=["MI_SPLIT2_Ab_4"]),
        K("MI_SPLIT2_A_4", "Triple\nSplit\nA₄", "Midi send note A₄"),
        K("MI_SPLIT2_As_4", "Triple\nSplit\nA#₄/Bᵇ₄", "Midi send note A#₄/Bᵇ₄", alias=["MI_SPLIT2_Bb_4"]),
        K("MI_SPLIT2_B_4", "Triple\nSplit\nB₄", "Midi send note B₄"),

        K("MI_SPLIT2_C_5", "Triple\nSplit\nC₅", "Midi send note C₅"),
        K("MI_SPLIT2_Cs_5", "Triple\nSplit\nC#₅/Dᵇ₅", "Midi send note C#₅/Dᵇ₅", alias=["MI_SPLIT2_Db_5"]),
        K("MI_SPLIT2_D_5", "Triple\nSplit\nD₅", "Midi send note D₅"),
        K("MI_SPLIT2_Ds_5", "Triple\nSplit\nD#₅/Eᵇ₅", "Midi send note D#₅/Eᵇ₅", alias=["MI_SPLIT2_Eb_5"]),
        K("MI_SPLIT2_E_5", "Triple\nSplit\nE₅", "Midi send note E₅"),
        K("MI_SPLIT2_F_5", "Triple\nSplit\nF₅", "Midi send note F₅"),
        K("MI_SPLIT2_Fs_5", "Triple\nSplit\nF#₅/Gᵇ₅", "Midi send note F#₅/Gᵇ₅", alias=["MI_SPLIT2_Gb_5"]),
        K("MI_SPLIT2_G_5", "Triple\nSplit\nG₅", "Midi send note G₅"),
        K("MI_SPLIT2_Gs_5", "Triple\nSplit\nG#₅/Aᵇ₅", "Midi send note G#₅/Aᵇ₅", alias=["MI_SPLIT2_Ab_5"]),
        K("MI_SPLIT2_A_5", "Triple\nSplit\nA₅", "Midi send note A₅"),
        K("MI_SPLIT2_As_5", "Triple\nSplit\nA#₅/Bᵇ₅", "Midi send note A#₅/Bᵇ₅", alias=["MI_SPLIT2_Bb_5"]),
        K("MI_SPLIT2_B_5", "Triple\nSplit\nB₅", "Midi send note B₅"),
...
KEYCODES_MIDI_CHANNEL_KEYSPLIT2 = [
    K("MI_CHANNEL_KEYSPLIT2_1", "Triple\nSplit\nChannel 1", "Midi set key split channel to 1"),
    K("MI_CHANNEL_KEYSPLIT2_2", "Triple\nSplit\nChannel 2", "Midi set key split channel to 2"),
    K("MI_CHANNEL_KEYSPLIT2_3", "Triple\nSplit\nChannel 3", "Midi set key split channel to 3"),
    K("MI_CHANNEL_KEYSPLIT2_4", "Triple\nSplit\nChannel 4", "Midi set key split channel to 4"),
    K("MI_CHANNEL_KEYSPLIT2_5", "Triple\nSplit\nChannel 5", "Midi set key split channel to 5"),
    K("MI_CHANNEL_KEYSPLIT2_6", "Triple\nSplit\nChannel 6", "Midi set key split channel to 6"),
    K("MI_CHANNEL_KEYSPLIT2_7", "Triple\nSplit\nChannel 7", "Midi set key split channel to 7"),
    K("MI_CHANNEL_KEYSPLIT2_8", "Triple\nSplit\nChannel 8", "Midi set key split channel to 8"),
    K("MI_CHANNEL_KEYSPLIT2_9", "Triple\nSplit\nChannel 9", "Midi set key split channel to 9"),
    K("MI_CHANNEL_KEYSPLIT2_10", "Triple\nSplit\nChannel 10", "Midi set key split channel to 10"),
    K("MI_CHANNEL_KEYSPLIT2_11", "Triple\nSplit\nChannel 11", "Midi set key split channel to 11"),
    K("MI_CHANNEL_KEYSPLIT2_12", "Triple\nSplit\nChannel 12", "Midi set key split channel to 12"),
    K("MI_CHANNEL_KEYSPLIT2_13", "Triple\nSplit\nChannel 13", "Midi set key split channel to 13"),
...
def recreate_keycodes():
    ...
    KEYCODES.extend(KEYCODES_SPECIAL + KEYCODES_BASIC + KEYCODES_SHIFTED + KEYCODES_ISO + KEYCODES_LAYERS + KEYCODES_LAYERS_DF + KEYCODES_LAYERS_MO + KEYCODES_LAYERS_TG + KEYCODES_LAYERS_TT + KEYCODES_LAYERS_OSL + KEYCODES_LAYERS_TO + KEYCODES_LAYERS_LT +
                    ...
                    KEYCODES_TAP_DANCE + KEYCODES_MACRO + KEYCODES_MACRO_BASE + KEYCODES_USER + KEYCODES_HIDDEN + KEYCODES_MIDI+ KEYCODES_MIDI_CHANNEL_OS + KEYCODES_MIDI_CHANNEL_HOLD + KEYCODES_RGB_KC_CUSTOM + KEYCODES_MIDI_CHANNEL_KEYSPLIT + KEYCODES_MIDI_CHANNEL_KEYSPLIT2 + KEYCODES_KEYSPLIT_BUTTONS +
