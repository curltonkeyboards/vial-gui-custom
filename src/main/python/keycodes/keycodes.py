...
# HE Velocity Curve keycodes - Factory curves
...
# HE Velocity Curve keycodes - User curves
KEYCODES_HE_VELOCITY_CURVE_USER = [
    K("HE_CURVE_USER_1", "HE Curve\nUser 1", "HE Velocity User Curve 1"),
    K("HE_CURVE_USER_2", "HE Curve\nUser 2", "HE Velocity User Curve 2"),
    K("HE_CURVE_USER_3", "HE Curve\nUser 3", "HE Velocity User Curve 3"),
    K("HE_CURVE_USER_4", "HE Curve\nUser 4", "HE Velocity User Curve 4"),
    K("HE_CURVE_USER_5", "HE Curve\nUser 5", "HE Velocity User Curve 5"),
    K("HE_CURVE_USER_6", "HE Curve\nUser 6", "HE Velocity User Curve 6"),
    K("HE_CURVE_USER_7", "HE Curve\nUser 7", "HE Velocity User Curve 7"),
    K("HE_CURVE_USER_8", "HE Curve\nUser 8", "HE Velocity User Curve 8"),
    K("HE_CURVE_USER_9", "HE Curve\nUser 9", "HE Velocity User Curve 9"),
    K("HE_CURVE_USER_10", "HE Curve\nUser 10", "HE Velocity User Curve 10"),
]
...
def recreate_keycodes():
    ...
    KEYCODES.extend(KEYCODES_SPECIAL + KEYCODES_BASIC + KEYCODES_SHIFTED + KEYCODES_ISO + KEYCODES_LAYERS + KEYCODES_LAYERS_DF + KEYCODES_LAYERS_MO + KEYCODES_LAYERS_TG + KEYCODES_LAYERS_TT + KEYCODES_LAYERS_OSL + KEYCODES_LAYERS_TO + KEYCODES_LAYERS_LT +
                    ...
                    KEYCODES_HE_VELOCITY_CURVE+KEYCODES_HE_VELOCITY_CURVE_USER+KEYCODES_HE_VELOCITY_RANGE+
