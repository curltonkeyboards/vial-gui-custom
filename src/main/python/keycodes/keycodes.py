...
KEYCODES_MACRO = [
    ...
    K("M98", "M98", "MACRO 98"),
    K("M99", "M99", "MACRO 99"),
    K("M100", "M100", "MACRO 100"),
    K("M101", "M101", "MACRO 101"),
    K("M102", "M102", "MACRO 102"),
    K("M103", "M103", "MACRO 103"),
    K("M104", "M104", "MACRO 104"),
    K("M105", "M105", "MACRO 105"),
    K("M106", "M106", "MACRO 106"),
    K("M107", "M107", "MACRO 107"),
    K("M108", "M108", "MACRO 108"),
    K("M109", "M109", "MACRO 109"),
    K("M110", "M110", "MACRO 110"),
    K("M111", "M111", "MACRO 111"),
    K("M112", "M112", "MACRO 112"),
    K("M113", "M113", "MACRO 113"),
    K("M114", "M114", "MACRO 114"),
    K("M115", "M115", "MACRO 115"),
    K("M116", "M116", "MACRO 116"),
    K("M117", "M117", "MACRO 117"),
    K("M118", "M118", "MACRO 118"),
    K("M119", "M119", "MACRO 119"),
    K("M120", "M120", "MACRO 120"),
    K("M121", "M121", "MACRO 121"),
    K("M122", "M122", "MACRO 122"),
    K("M123", "M123", "MACRO 123"),
    K("M124", "M124", "MACRO 124"),
