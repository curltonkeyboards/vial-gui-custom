...
themes = [
    ...
    ("Arc", {
        QPalette.Window: "#ff6700",
        QPalette.WindowText: "#ffffff",
        QPalette.Base: "#333333",
        QPalette.AlternateBase: "#cfbda4",
        QPalette.ToolTipBase: "#3e2308",
        QPalette.ToolTipText: "#333333",
        QPalette.Text: "#333333",
        QPalette.Button: "#ffffff",
        QPalette.ButtonText: "#ff6700",
        QPalette.BrightText: "#ffffff",
        QPalette.Link: "#cfbda4",
        QPalette.Highlight: "#3e2308",
        QPalette.HighlightedText: "#333333",
        (QPalette.Active, QPalette.Button): "#cfbda4",
        (QPalette.Disabled, QPalette.ButtonText): "#3e2308",
        (QPalette.Disabled, QPalette.WindowText): "#cfbda4",
        (QPalette.Disabled, QPalette.Text): "#3e2308",
        (QPalette.Disabled, QPalette.Light): "#cfbda4",
    }),
    ("Nord", {
