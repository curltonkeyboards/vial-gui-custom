...
CMD_VIAL_LAYER_RGB_SAVE = 0xBC
CMD_VIAL_LAYER_RGB_LOAD = 0xBD
CMD_VIAL_LAYER_RGB_ENABLE = 0xBE
CMD_VIAL_LAYER_RGB_GET_STATUS = 0xBF
CMD_VIAL_CUSTOM_ANIM_SET_PARAM = 0xC0
CMD_VIAL_CUSTOM_ANIM_GET_PARAM = 0xC1  
CMD_VIAL_CUSTOM_ANIM_SET_ALL = 0xC2
CMD_VIAL_CUSTOM_ANIM_GET_ALL = 0xC3
CMD_VIAL_CUSTOM_ANIM_SAVE = 0xC4
CMD_VIAL_CUSTOM_ANIM_LOAD = 0xC5
CMD_VIAL_CUSTOM_ANIM_RESET_SLOT = 0xC6
...
CMD_VIAL_THRULOOP_SET_CONFIG = 0xB0
CMD_VIAL_THRULOOP_SET_MAIN_CCS = 0xB1  
CMD_VIAL_THRULOOP_SET_OVERDUB_CCS = 0xB2
CMD_VIAL_THRULOOP_SET_NAVIGATION = 0xB3
CMD_VIAL_THRULOOP_GET_CONFIG = 0xB4
CMD_VIAL_THRULOOP_RESET = 0xB5

# MIDIswitch Commands (0xB6-0xBB)
CMD_VIAL_MIDI_SET_CONFIG = 0xB6
CMD_VIAL_MIDI_GET_CONFIG = 0xB7
CMD_VIAL_MIDI_RESET_CONFIG = 0xB8
CMD_VIAL_MIDI_SAVE_SLOT = 0xB9
CMD_VIAL_MIDI_LOAD_SLOT = 0xBA
CMD_VIAL_MIDI_SET_ADVANCED = 0xBB
