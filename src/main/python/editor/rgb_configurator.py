...
VIALRGB_EFFECTS = [
    ...
    VialRGBEffect(57, "Random Lights - Loop Controlled 1"),
    VialRGBEffect(58, "Random Lights - Loop Controlled 2"),
    VialRGBEffect(59, "Random Lights - Loop Controlled 3"),
    VialRGBEffect(60, "Random Lights - Loop Controlled 4"),
    VialRGBEffect(61, "Random Lights - BPM Controlled 1"),
    VialRGBEffect(62, "Random Lights - BPM Controlled 2"),
    VialRGBEffect(63, "Random Lights - BPM Controlled 3"),
    VialRGBEffect(64, "Random Lights - BPM Controlled 4"),
    VialRGBEffect(65, "Custom Slot 1"),
    VialRGBEffect(66, "Custom Slot 2"),
    VialRGBEffect(67, "Custom Slot 3"),
    VialRGBEffect(68, "Custom Slot 4"),
    VialRGBEffect(69, "Custom Slot 5"),
    VialRGBEffect(70, "Custom Slot 6"),
    VialRGBEffect(71, "Custom Slot 7"),
    VialRGBEffect(72, "Custom Slot 8"),
    VialRGBEffect(73, "Custom Slot 9"),
    VialRGBEffect(74, "Custom Slot 10"),
    VialRGBEffect(75, "Custom Slot 11"),
    VialRGBEffect(76, "Custom Slot 12"),
]
