...
class QuickActuationWidget(QGroupBox):
    ...
    def __init__(self):
        ...
        self.aftertouch_combo.setStyleSheet("QComboBox { padding: 0px; font-size: 12px; text-align: center; } QComboBox QAbstractItemView { min-height: 125px; }")
        ...
        self.velocity_combo.setStyleSheet("QComboBox { padding: 0px; font-size: 12px; text-align: center; } QComboBox QAbstractItemView { min-height: 100px; }")
        ...
        self.he_curve_combo.setStyleSheet("QComboBox { padding: 0px; font-size: 12px; text-align: center; } QComboBox QAbstractItemView { min-height: 125px; }")
