...
class QuickActuationWidget(QGroupBox):
    ...
    def __init__(self):
        ...
        self.aftertouch_combo.setStyleSheet("QComboBox { padding: 0px; font-size: 12px; }")
        self.aftertouch_combo.setMaxVisibleItems(5)
        ...
        self.aftertouch_cc_combo.setStyleSheet("QComboBox { padding: 0px; font-size: 12px; }")
        self.aftertouch_cc_combo.setMaxVisibleItems(10)
        for cc in range(128):
        ...
        self.velocity_combo.setStyleSheet("QComboBox { padding: 0px; font-size: 12px; }")
        self.velocity_combo.setMaxVisibleItems(4)
        ...
        self.vel_speed_combo.setStyleSheet("QComboBox { padding: 0px; font-size: 12px; }")
        self.vel_speed_combo.setMaxVisibleItems(10)
        for i in range(1, 21):
        ...
        self.he_curve_combo.setMaxVisibleItems(5)
