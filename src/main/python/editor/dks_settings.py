...
from tabbed_keycodes import KeyboardTab, MusicTab, GamingTab, MacroTab, LightingTab, MIDITab, SimpleTab, LayersTab
from keycodes.keycodes import (KEYCODES_MACRO_BASE, KEYCODES_MACRO, KEYCODES_TAP_DANCE, KEYCODES_BACKLIGHT,
                               ...
                               KEYCODES_RGB_KC_CUSTOM2, KEYCODES_CLEAR, KEYCODES_GAMING, KEYCODES_LAYERS, KEYCODES_LAYERS_DF, 
             KEYCODES_LAYERS_MO, KEYCODES_LAYERS_TG, KEYCODES_LAYERS_TT, 
