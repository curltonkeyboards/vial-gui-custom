...
// Note: arp_load_factory_preset() is implemented in arp_factory_presets.c
// It loads factory presets on-demand into the specified destination slot
...
void arp_init(void) {
    ...
    arp_state.mode = ARPMODE_SINGLE_NOTE;
