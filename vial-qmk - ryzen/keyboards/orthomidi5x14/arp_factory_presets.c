...
void arp_load_factory_preset(uint8_t preset_id, arp_preset_t *dest) {
    ...
    case 0:  // Up 16ths - Classic ascending 16th notes
        ...
        dest->note_count = 4;
        dest->pattern_length_16ths = 4;  // 4 16th notes
    ...
    case 2:  // Up-Down 16ths (Exclusive)
        dest->preset_type = PRESET_TYPE_ARPEGGIATOR;
        dest->note_count = 6;
        dest->pattern_length_16ths = 6;  // 6 16th notes (up 0-3, down 2-1)
        dest->gate_length_percent = 80;
        dest->timing_mode = TIMING_MODE_STRAIGHT;
        dest->note_value = NOTE_VALUE_SIXTEENTH;  // Step on every 16th note
        dest->magic = ARP_PRESET_MAGIC;
    ...
    case 3:  // Random 8ths
        dest->preset_type = PRESET_TYPE_ARPEGGIATOR;
        dest->note_count = 4;
        dest->pattern_length_16ths = 4;  // 4 8th notes (each 8th = 2 16ths, but we step in 8ths)
    ...
    case 4:  // Up 2 Octaves
        dest->preset_type = PRESET_TYPE_ARPEGGIATOR;
        dest->note_count = 8;
        dest->pattern_length_16ths = 8;  // 8 16th notes
        dest->gate_length_percent = 80;
        dest->timing_mode = TIMING_MODE_STRAIGHT;
    ...
    case 6:  // Octave Jump
        dest->preset_type = PRESET_TYPE_ARPEGGIATOR;
        dest->note_count = 8;
        dest->pattern_length_16ths = 8;  // 8 8th notes
        dest->gate_length_percent = 75;
        dest->timing_mode = TIMING_MODE_STRAIGHT;
...
void seq_load_factory_preset(uint8_t preset_id, seq_preset_t *dest) {
    ...
    case 0:  // C Major Scale
        ...
        dest->note_count = 8;
        dest->pattern_length_16ths = 8;  // 8 steps for 8 quarter notes
        dest->gate_length_percent = 80;
        dest->timing_mode = TIMING_MODE_STRAIGHT;
        dest->note_value = NOTE_VALUE_QUARTER;
        dest->magic = ARP_PRESET_MAGIC;
    ...
    case 1:  // Bass Line
        dest->preset_type = PRESET_TYPE_STEP_SEQUENCER;
        dest->note_count = 4;
        dest->pattern_length_16ths = 4;  // 4 steps for 4 quarter notes (1 bar)
    ...
    case 3:  // Melody 1
        dest->preset_type = PRESET_TYPE_STEP_SEQUENCER;
        dest->note_count = 8;
        dest->pattern_length_16ths = 8;  // 8 steps for 8 quarter notes (2 bars)
        dest->gate_length_percent = 75;
        dest->timing_mode = TIMING_MODE_STRAIGHT;
        dest->note_value = NOTE_VALUE_QUARTER;
        dest->magic = ARP_PRESET_MAGIC;
