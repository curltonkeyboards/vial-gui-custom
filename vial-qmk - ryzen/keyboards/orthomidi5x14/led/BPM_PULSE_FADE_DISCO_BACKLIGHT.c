...
// BPM_PULSE_FADE_DISCO_BACKLIGHT Effect
RGB_MATRIX_EFFECT(BPM_PULSE_FADE_DISCO_BACKLIGHT)
static bool bpm_pulse_fade_disco_backlight_runner(effect_params_t* params) {
...
bool BPM_PULSE_FADE_DISCO_BACKLIGHT(effect_params_t* params) {
    return bpm_pulse_fade_disco_backlight_runner(params);
}