...
// BPM_ALL_BACKLIGHT Effect
RGB_MATRIX_EFFECT(BPM_ALL_BACKLIGHT)
static bool bpm_all_backlight_runner(effect_params_t* params) {
...
bool BPM_ALL_BACKLIGHT(effect_params_t* params) {
    return bpm_all_backlight_runner(params);
}