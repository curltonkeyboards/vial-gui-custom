...
// BPM_PULSE_FADE_BACKLIGHT Effect
RGB_MATRIX_EFFECT(BPM_PULSE_FADE_BACKLIGHT)
static bool bpm_pulse_fade_backlight_runner(effect_params_t* params) {
...
bool BPM_PULSE_FADE_BACKLIGHT(effect_params_t* params) {
    return bpm_pulse_fade_backlight_runner(params);
}