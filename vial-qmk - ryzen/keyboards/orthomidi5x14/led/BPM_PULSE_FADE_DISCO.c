...
// BPM_PULSE_FADE_DISCO Effect
RGB_MATRIX_EFFECT(BPM_PULSE_FADE_DISCO)
static bool bpm_pulse_fade_disco_runner(effect_params_t* params) {
...
bool BPM_PULSE_FADE_DISCO(effect_params_t* params) {
    return bpm_pulse_fade_disco_runner(params);
}