...
// BPM_COLUMN_DISCO_BACKLIGHT Effect
RGB_MATRIX_EFFECT(BPM_COLUMN_DISCO_BACKLIGHT)
static bool bpm_column_disco_backlight_runner(effect_params_t* params) {
...
bool BPM_COLUMN_DISCO_BACKLIGHT(effect_params_t* params) {
    return bpm_column_disco_backlight_runner(params);
}