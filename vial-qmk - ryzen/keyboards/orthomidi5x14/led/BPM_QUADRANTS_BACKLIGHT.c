...
// BPM_QUADRANTS_BACKLIGHT Effect
RGB_MATRIX_EFFECT(BPM_QUADRANTS_BACKLIGHT)
static bool bpm_quadrants_backlight_runner(effect_params_t* params) {
...
bool BPM_QUADRANTS_BACKLIGHT(effect_params_t* params) {
    return bpm_quadrants_backlight_runner(params);
}
